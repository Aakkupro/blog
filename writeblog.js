...
//             editButtonHTML = `<button onclick="editPost(${index})">Edit</button>`;
//         }
...
//     titleElement.innerHTML = `<input type="text" id="edit-title-${index}" value="${title}">`;
//     contentElement.innerHTML = `<textarea id="edit-content-${index}">${content}</textarea>`;
//     const editButton = event.target;
//     editButton.textContent = "Save";
//     editButton.setAttribute("onclick", `savePost(${index})`);
// }

// function savePost(index) {
//     const editTitle = document.getElementById(`edit-title-${index}`).value;
//     const editContent = document.getElementById(`edit-content-${index}`).value;

//     const posts = JSON.parse(localStorage.getItem('posts')) || [];
//     posts[index].title = editTitle;
//     posts[index].content = editContent;
